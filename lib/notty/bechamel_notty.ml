...
module One = struct
  let image_of_header ~rect result =
    ...
    grid
      [
        [
          corner_tl 1 1; line (max_length_of_names + 4) 1; break_t 1 1;
          line (rect.w - 2 - 1 - (max_length_of_names + 4)) 1; corner_tr 1 1;
        ];
        [
          sideline 1 1; I.(string A.(st italic) "name");
          I.void max_length_of_names 1; sideline 1 1;
        ...
        [
          break_l 1 1; line (max_length_of_names + 4) 1; cross 1 1;
          line (rect.w - 2 - 1 - (max_length_of_names + 4)) 1; break_r 1 1;
        ];
      ]
  ...
  let image_of_field ~max_length_of_names ~rect ~predictor img (name, v) =
    ...
    let field =
      grid
        [
          [
            sideline 1 1; I.(string A.empty name |> hpad 2 0);
  ...
  let best_and_worst_case (result : Analyze.OLS.t result) ~sort ~predictor ~rect
    ...
    grid
      [
        ...
        [
          sideline 1 1; I.(string A.(st italic) "best");
          I.void max_length_of_names 1; sideline 1 1;
        ...
        [
          sideline 1 1; I.(string A.(st italic) "worst");
          I.void (max_length_of_names - 1) 1; sideline 1 1;
        ...
        [
          corner_bl 1 1; line (max_length_of_names + 4) 1; break_b 1 1;
          line (rect.w - 2 - 1 - (max_length_of_names + 4)) 1; corner_br 1 1;
        ];
      ]
    ...
    let cc =
      List.map
        (fun instance ->
          ...
          [
            sideline 1 1; I.(string A.empty instance |> I.hpad 2 0);
            I.void rest 0;
          ])
        instances
      |> List.concat
